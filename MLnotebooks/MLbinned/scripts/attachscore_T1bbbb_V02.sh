...
#do
#    filename1=${filename##*/}
#    python addMLscore_V02.py $filename /scratch/wjin/featurereduced4/bkg_score/score1_forT1bbbb_2016_${filename1/".root"/"_bin.npy"}
#done
...
#do
#    filename1=${filename##*/}
#    python addMLscore_V02.py $filename /scratch/wjin/featurereduced4/sig_score/score1_forT1bbbb_2016_${filename1/".root"/"_bin.npy"}
#done
...
do
    filename1=${filename##*/}
    python addMLscore_V02.py $filename /scratch/wjin/featurereduced4/zinvcontrol_score/score1_forT1bbbb_2016_${filename1/".root"/"_bin.npy"}
done
...
do
    filename1=${filename##*/}
    python addMLscore_V02.py $filename /scratch/wjin/featurereduced4/llcontrol_score/score1_forT1bbbb_2016_${filename1/".root"/"_bin.npy"}
done
...
do
    filename1=${filename##*/}
    python addMLscore_V02.py $filename /scratch/wjin/featurereduced4/bkg_score/score1_forT1bbbb_2017_${filename1/".root"/"_bin.npy"}
done
...
do
    filename1=${filename##*/}
    python addMLscore_V02.py $filename /scratch/wjin/featurereduced4/sig_score/score1_forT1bbbb_2017_${filename1/".root"/"_bin.npy"}
done
...
do
    filename1=${filename##*/}
    python addMLscore_V02.py $filename /scratch/wjin/featurereduced4/zinvcontrol_score/score1_forT1bbbb_2017_${filename1/".root"/"_bin.npy"}
done
...
do
    filename1=${filename##*/}
    python addMLscore_V02.py $filename /scratch/wjin/featurereduced4/llcontrol_score/score1_forT1bbbb_2017_${filename1/".root"/"_bin.npy"}
done
...
do
    filename1=${filename##*/}
    python addMLscore_V02.py $filename /scratch/wjin/featurereduced4/bkg_score/score1_forT1bbbb_2018_${filename1/".root"/"_bin.npy"}
done

for filename in /scratch/wjin/featurereduced4/rootfiles_zinvcontrol/2018/*.root
do
    filename1=${filename##*/}
    python addMLscore_V02.py $filename /scratch/wjin/featurereduced4/zinvcontrol_score/score1_forT1bbbb_2018_${filename1/".root"/"_bin.npy"}
done

for filename in /scratch/wjin/featurereduced4/rootfiles_llcontrol/2018/*.root
do
    filename1=${filename##*/}
    python addMLscore_V02.py $filename /scratch/wjin/featurereduced4/llcontrol_score/score1_forT1bbbb_2018_${filename1/".root"/"_bin.npy"}
done
