...
for filename in os.listdir(directory):
    if filename.endswith(".root"):
        for signal in signaltype:
            ...
            outputfile= targetdir+"score1_for"+signal+"_2016_"+filename.replace(".root","_incluV3.npy")
...
for filename in os.listdir(directory):
    for signal in signaltype:
        if filename.endswith(".root") and (signal in filename) :
            inputfile = directory+filename
            outputfile= targetdir+"score1_2016_"+filename.replace(".root","_incluV3.npy")
            if os.path.isfile(outputfile):
                continue
...
for filename in os.listdir(directory):
    if filename.endswith(".root"):
        for signal in signaltype:
            inputfile = directory+filename
            outputfile= targetdir+"score1_for"+signal+"_2017_"+filename.replace(".root","_incluV3.npy")
            if os.path.isfile(outputfile):
                continue
...
for filename in os.listdir(directory):
    for signal in signaltype:
        if filename.endswith(".root") and (signal in filename):
            inputfile = directory+filename
            outputfile= targetdir+"score1_2017_"+filename.replace(".root","_incluV3.npy")
            if os.path.isfile(outputfile):
                continue
...
for filename in os.listdir(directory):
    if filename.endswith(".root"):
        for signal in signaltype:
            inputfile = directory+filename
            outputfile= targetdir+"score1_for"+signal+"_2018_"+filename.replace(".root","_incluV3.npy")
            if os.path.isfile(outputfile):
                continue
