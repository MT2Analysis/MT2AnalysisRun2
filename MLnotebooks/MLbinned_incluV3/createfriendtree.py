...
#    bins=[13,15,16,18,19,20,23,25,26,32,33,34,45,46,54,55,57,64,65]
    bins=[13,15,18,19,20,25,32,45,46,54,55,64,65]
...
#    bins=[0,7,8,10,11,14,15,17,18,19,21,22,24,25,28,29,31,32,39,43,44,45,48,49,53,54,63,64,65]
    bins=[0,7,8,10,11,14,15,17,18,19,24,25,28,31,32,39,43,44,45,48,49,53,54,63,64,65]
...
for ientry in range(nentries):
    for iscore in range(len(bins)):
        score[iscore][0]=prediction[0][ientry]
    tree1.Fill()
f1.Write()
f1.Close()
