...
directory_T1bbbb_incluNN_1 = "/work/wjin/CMSSW_8_0_12/src/CMSSW_8_0_12/src/myMT2Analysis/analysis/EventYields_config_MLoptimize_2016_ForT1bbbb_incluV1_1/datacards_T1bbbb/"
directory_T1qqqq_incluNN_1 = "/work/wjin/CMSSW_8_0_12/src/CMSSW_8_0_12/src/myMT2Analysis/analysis/EventYields_config_MLoptimize_2016_ForT1qqqq_incluV1_1/datacards_T1qqqq/"
directory_T2bb_incluNN_1 = "/work/wjin/CMSSW_8_0_12/src/CMSSW_8_0_12/src/myMT2Analysis/analysis/EventYields_config_MLoptimize_2016_ForT2bb_incluV1_1/datacards_T2bb/"
directory_T2qq_incluNN_1 = "/work/wjin/CMSSW_8_0_12/src/CMSSW_8_0_12/src/myMT2Analysis/analysis/EventYields_config_MLoptimize_2016_ForT2qq_incluV1_1/datacards_T2qq/"
...
labels=("nominal","after optimize\n(GBDT)","after optimize\n(GBDT)\n"+r'$dataCR \geq 5$',"after optimize\n(GBDT)\n"+r'$dataCR \geq 10$',"after optimize\n(NN)","after optimize\n(NN)\n"+r'$dataCR \geq 5$',"after optimize\n(NN)\n"+r'$dataCR \geq 10$')

for i in range(8):
    point=points_T1bbbb[i]
    mass=masses_T1bbbb[i]
    figure=plotlimit_robust([directory_T1bbbb_origin+point,directory_T1bbbb_BDT_1+point,directory_T1bbbb_BDT_5+point,directory_T1bbbb_BDT_10+point,directory_T1bbbb_NN_1+point,directory_T1bbbb_NN_5+point,directory_T1bbbb_NN_10+point],labels,"Expected Limit comparison for T1bbbb mass "+str(mass[0])+" "+str(mass[1]))
    figure.savefig("limit_T1bbbb_"+str(mass[0])+"_"+str(mass[1])+"_robustcheckBDTNN"+".png")
    figure.savefig("limit_T1bbbb_"+str(mass[0])+"_"+str(mass[1])+"_robustcheckBDTNN"+".pdf")
    plt.close('all')

for i in range(8):
    point=points_T1qqqq[i]
    mass=masses_T1qqqq[i]
    figure=plotlimit_robust([directory_T1qqqq_origin+point,directory_T1qqqq_BDT_1+point,directory_T1qqqq_BDT_5+point,directory_T1qqqq_BDT_10+point,directory_T1qqqq_NN_1+point,directory_T1qqqq_NN_5+point,directory_T1qqqq_NN_10+point],labels,"Expected Limit comparison for T1qqqq mass "+str(mass[0])+" "+str(mass[1]))
    figure.savefig("limit_T1qqqq_"+str(mass[0])+"_"+str(mass[1])+"_robustcheckBDTNN"+".png")
    figure.savefig("limit_T1qqqq_"+str(mass[0])+"_"+str(mass[1])+"_robustcheckBDTNN"+".pdf")
    plt.close('all')

for i in range(8):
    point=points_T2bb[i]
    mass=masses_T2bb[i]
    figure=plotlimit_robust([directory_T2bb_origin+point,directory_T2bb_BDT_1+point,directory_T2bb_BDT_5+point,directory_T2bb_BDT_10+point,directory_T2bb_NN_1+point,directory_T2bb_NN_5+point,directory_T2bb_NN_10+point],labels,"Expected Limit comparison for T2bb mass "+str(mass[0])+" "+str(mass[1]))
    figure.savefig("limit_T2bb_"+str(mass[0])+"_"+str(mass[1])+"_robustcheckBDTNN"+".png")
    figure.savefig("limit_T2bb_"+str(mass[0])+"_"+str(mass[1])+"_robustcheckBDTNN"+".pdf")
    plt.close('all')

for i in range(8):
    point=points_T2qq[i]
    mass=masses_T2qq[i]
    figure=plotlimit_robust([directory_T2qq_origin+point,directory_T2qq_BDT_1+point,directory_T2qq_BDT_5+point,directory_T2qq_BDT_10+point,directory_T2qq_NN_1+point,directory_T2qq_NN_5+point,directory_T2qq_NN_10+point],labels,"Expected Limit comparison for T2qq mass "+str(mass[0])+" "+str(mass[1]))
    figure.savefig("limit_T2qq_"+str(mass[0])+"_"+str(mass[1])+"_robustcheckBDTNN"+".png")
    figure.savefig("limit_T2qq_"+str(mass[0])+"_"+str(mass[1])+"_robustcheckBDTNN"+".pdf")
    plt.close('all')

labels=("nominal","after optimize (BDT)","after optimize (NN)","after optimize (incluNN)")
for i in range(8):
    point=points_T1bbbb[i]
    mass=masses_T1bbbb[i]
    figure=plotlimit_robust([directory_T1bbbb_origin+point,directory_T1bbbb_BDT_1+point,directory_T1bbbb_NN_1+point,directory_T1bbbb_incluNN_1+point],labels,"Expected Limit comparison for T1bbbb mass "+str(mass[0])+" "+str(mass[1]))
    figure.savefig("limit_T1bbbb_"+str(mass[0])+"_"+str(mass[1])+"_compareincluNN"+".png")
    figure.savefig("limit_T1bbbb_"+str(mass[0])+"_"+str(mass[1])+"_compareincluNN"+".pdf")
    plt.close('all')

for i in range(8):
    point=points_T1qqqq[i]
    mass=masses_T1qqqq[i]
    figure=plotlimit_robust([directory_T1qqqq_origin+point,directory_T1qqqq_BDT_1+point,directory_T1qqqq_NN_1+point,directory_T1qqqq_incluNN_1+point],labels,"Expected Limit comparison for T1qqqq mass "+str(mass[0])+" "+str(mass[1]))
    figure.savefig("limit_T1qqqq_"+str(mass[0])+"_"+str(mass[1])+"_compareincluNN"+".png")
    figure.savefig("limit_T1qqqq_"+str(mass[0])+"_"+str(mass[1])+"_compareincluNN"+".pdf")
    plt.close('all')

for i in range(8):
    point=points_T2bb[i]
    mass=masses_T2bb[i]
    figure=plotlimit_robust([directory_T2bb_origin+point,directory_T2bb_BDT_1+point,directory_T2bb_NN_1+point,directory_T2bb_incluNN_1+point],labels,"Expected Limit comparison for T2bb mass "+str(mass[0])+" "+str(mass[1]))
    figure.savefig("limit_T2bb_"+str(mass[0])+"_"+str(mass[1])+"_compareincluNN"+".png")
    figure.savefig("limit_T2bb_"+str(mass[0])+"_"+str(mass[1])+"_compareincluNN"+".pdf")
    plt.close('all')

for i in range(8):
    point=points_T2qq[i]
    mass=masses_T2qq[i]
    figure=plotlimit_robust([directory_T2qq_origin+point,directory_T2qq_BDT_1+point,directory_T2qq_NN_1+point,directory_T2qq_incluNN_1+point],labels,"Expected Limit comparison for T2qq mass "+str(mass[0])+" "+str(mass[1]))
    figure.savefig("limit_T2qq_"+str(mass[0])+"_"+str(mass[1])+"_compareincluNN"+".png")
    figure.savefig("limit_T2qq_"+str(mass[0])+"_"+str(mass[1])+"_compareincluNN"+".pdf")
    plt.close('all')
