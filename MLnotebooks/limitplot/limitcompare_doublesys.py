...
def plotlimit(filenamelist,labels,title):
...
directory_T1bbbb_origin_doublesys ="/work/wjin/CMSSW_8_0_12/src/CMSSW_8_0_12/src/myMT2Analysis/analysis/EventYields_config_MLoptimize_2016_ForT1bbbb_btagexclu_noMLcutallevents/datacards_T1bbbb_doublesys/"
directory_T1bbbb_BDT_1_doublesys = "/work/wjin/CMSSW_8_0_12/src/CMSSW_8_0_12/src/myMT2Analysis/analysis/EventYields_config_MLoptimize_2016_ForT1bbbb_BDTV3_2_1/datacards_T1bbbb_doublesys/"
...
labels=("nominal","after optimize (GBDT)","nominal\nSysUnc"+r'$\times 2$',"after optimize (GBDT)\nSysUnc"+r'$\times 2$')

for i in range(8):
    point=points_T1bbbb[i]
    mass=masses_T1bbbb[i]
    figure=plotlimit([directory_T1bbbb_origin+point,directory_T1bbbb_BDT_1+point,directory_T1bbbb_origin_doublesys+point,directory_T1bbbb_BDT_1_doublesys+point],labels,"Expected Limit comparison for T1bbbb mass "+str(mass[0])+" "+str(mass[1]))
    figure.savefig("limit_T1bbbb_"+str(mass[0])+"_"+str(mass[1])+"_doublesys"+".png")
    figure.savefig("limit_T1bbbb_"+str(mass[0])+"_"+str(mass[1])+"_doublesys"+".pdf")
    plt.close('all')
