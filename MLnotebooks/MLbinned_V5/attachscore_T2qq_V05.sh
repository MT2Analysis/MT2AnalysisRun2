...
do
    filename1=${filename##*/}
    if [ -f /scratch/wjin/featurereduced4/bkg_score/score1_forT2qq_2016_${filename1/".root"/"_binV5.npy"} ];then
        echo "file exist"
        continue
    fi
    python addMLscore_V05.py $filename /scratch/wjin/featurereduced4/bkg_score/score1_forT2qq_2016_${filename1/".root"/"_binV5.npy"} "mt2" "T2qq"
done &
...
do
    ...
    python addMLscore_V05.py $filename /scratch/wjin/featurereduced4/zinvcontrol_score/score1_forT2qq_2016_${filename1/".root"/"_binV5.npy"} "mt2" "T2qq"
done &
...
do
    ...
    python addMLscore_V05.py $filename /scratch/wjin/featurereduced4/llcontrol_score/score1_forT2qq_2016_${filename1/".root"/"_binV5.npy"} "mt2" "T2qq"
done &
...
do
    filename1=${filename##*/}
    if [ -f /scratch/wjin/featurereduced4/bkg_score/score1_forT2qq_2017_${filename1/".root"/"_binV5.npy"} ];then
        echo "file exist"
        continue
    fi
    python addMLscore_V05.py $filename /scratch/wjin/featurereduced4/bkg_score/score1_forT2qq_2017_${filename1/".root"/"_binV5.npy"} "mt2" "T2qq"
done &
...
do
    ...
    python addMLscore_V05.py $filename /scratch/wjin/featurereduced4/zinvcontrol_score/score1_forT2qq_2017_${filename1/".root"/"_binV5.npy"} "mt2" "T2qq"
done &
...
do
    ...
    python addMLscore_V05.py $filename /scratch/wjin/featurereduced4/llcontrol_score/score1_forT2qq_2017_${filename1/".root"/"_binV5.npy"} "mt2" "T2qq"
done &
...
do
    filename1=${filename##*/}
    if [ -f /scratch/wjin/featurereduced4/bkg_score/score1_forT2qq_2018_${filename1/".root"/"_binV5.npy"} ];then
        echo "file exist"
        continue
    fi
    python addMLscore_V05.py $filename /scratch/wjin/featurereduced4/bkg_score/score1_forT2qq_2018_${filename1/".root"/"_binV5.npy"} "mt2" "T2qq"
done &
...
do
    ...
    python addMLscore_V05.py $filename /scratch/wjin/featurereduced4/zinvcontrol_score/score1_forT2qq_2018_${filename1/".root"/"_binV5.npy"} "mt2" "T2qq"
done &
...
do
    ...
    python addMLscore_V05.py $filename /scratch/wjin/featurereduced4/llcontrol_score/score1_forT2qq_2018_${filename1/".root"/"_binV5.npy"} "mt2" "T2qq"
done &
wait
