...
#            print('Reading branch=', ib)
        ...
        if signaltype=="T1bbbb" or signaltype=="T1qqqq":
            model='weights_'+signaltype+'_bin_'+str(binindex)+'_try4.best.hdf5'
            d1=np.load("significance_"+signaltype+"_output_try4.npy",allow_pickle=True)
        elif signaltype=="T2bb":
            model='weights_'+signaltype+'_bin_'+str(binindex)+'_try5.best.hdf5'
            d1=np.load("significance_"+signaltype+"_output_try5.npy",allow_pickle=True)
        else:
            model='weights_'+signaltype+'_bin_'+str(binindex)+'.best.hdf5'
