...
//void MT2DrawTools::drawRegionYields_fromTree( MT2Analysis<MT2EstimateTree>* data, std::vector<MT2Analysis<MT2EstimateTree>* >  bgYields, const std::string& saveName, const std::string& varName, const std::string& selection, int nBins, float xMin, float xMax, std::string axisName, const std::string& units, const std::string& kinCuts ) {
  ...
  for( std::set<MT2Region>::iterator iMT2 = MT2Regions.begin(); iMT2!=MT2Regions.end(); ++iMT2 ) {
    ...
    //cout << "[0] entries hist0:" << histos_mc_sep[0]->GetEntries() << endl;
    //cout << "[0] entries hist intermediate:" << h1_int1->GetEntries() << "vs " << histos_mc_sep[0]->GetEntries()+histos_mc_sep[1]->GetEntries() << endl;
    //cout << "[0] entries hist tot:" << h1_int2->GetEntries() << endl;

    histos_mc[0] = h1_int2;

    //cout << "entries histos_mc 0: " << histos_mc[0]->GetEntries() << endl;
    ...
    //cout << "[1] entries hist0:" << histos_mc_sep[3]->GetEntries() << endl;
    //cout << "[1] entries hist intermediate:" << h1_int3->GetEntries() << "vs " << histos_mc_sep[3]->GetEntries()+histos_mc_sep[4]->GetEntries() << endl;
    //cout << "[1] entries hist tot:" << h1_int4->GetEntries() << endl;
  
    histos_mc[1] = h1_int4;  

    //cout << "entries histos_mc 1: " << histos_mc[1]->GetEntries() << endl;
